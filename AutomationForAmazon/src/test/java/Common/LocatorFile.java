...
public class LocatorFile {
    ...
    //public By signButton = By.xpath("//*[@id='nav-link-accountList']");
    //public By signButton = By.cssSelector("#nav-link-accountList");
    public By signButton = By.xpath("//*[@id=\"nav-signin-tooltip\"]/a/span");
    public By emailField = By.id("ap_email_login");
    public By passwordField = By.id("ap_password");
    public By invaildEmail = By.id("invalid-email-alert");
    public By continueButtonForEmail = By.id("continue");
    public By signInButtonForPassword = By.id("signInSubmit");
    public By invalidPassword = By.xpath("//*[@id='auth-error-message-box']/div");
